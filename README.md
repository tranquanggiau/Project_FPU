...
This project focuses on hardware architecture design, synthesis, timing analysis, and functional verification, demonstrating a practical FPGA development workflow suitable for Hardware / FPGA Engineer roles.
...
Normalized representation with a hidden leading bit.
...
1. Operand Decomposition

Extract sign, exponent, mantissa

Hidden-bit reconstruction

2. Exponent Alignment (Add/Sub)
...
4. Normalization & Exponent Adjustment
...
Reassemble the IEEE 754 output format
